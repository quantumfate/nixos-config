    ...
    wayland.windowManager.hyprland = {
      settings = {
        windowrule = [
          ...
          "opacity 0.98 0.95, match:tag chromium-based-browser"
          "opacity 0.98 0.95, match:tag firefox-based-browser"
          #"opacity 1.0 1.0, initialTitle:((?i)(?:[a-z0-9-]+.)*youtube.com_/|app.zoom.us_/wc/home|twitch.tv_/)"
