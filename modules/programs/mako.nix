  ...
  home-manager.users."${userCfg.name}" = {
    ...
    services.mako = {
      ...
      settings = {
        ...
        "urgency=normal" = {
          border-color = "${catppuccin.hex.green}";
        };
        "urgency=high" = {
        ...
        "app-name=whatsapp-electron" = {
          ...
          padding = "0,0,0,30";
          format = "<b>%s</b>\\n%b";
          on-button-left = "exec hyprctl dispatch focuswindow class:whatsapp-electron";
        };
        "app-name=vesktop" = {
          default-timeout = 0;
          icon-border-radius = 8;
          ...
          padding = "0,0,0,30";
          format = "<b>%s</b>\\n%b";
          on-button-left = "exec hyprctl dispatch focuswindow class:vesktop";
        };
